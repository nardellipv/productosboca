                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image" align="center">
                                                                <a href="https://viewstripo.email/" target="_blank"><img src="https://tlr.stripocdn.email/content/guids/CABINET_b3156304f6ea49ad12cf8a28ac247f14/images/74601518438433060.png" alt="Financial logo" title="Financial logo" width="134"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <h3 style="color: #666666;">Hola,</h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t" align="left">
                                                                <p style="color: #999999;">Se a comprado un producto recientemente:</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t" align="left">
                                                                <p style="color: #999999;">Nombre: {!! $name !!}</p>
                                                                <p style="color: #999999;">Email: {{ $email }}</p>
                                                                <p style="color: #999999;">Teléfono: {{ $phone }}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p15t" align="left">
                                                                <p style="color: #999999;">Muchas gracias</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
