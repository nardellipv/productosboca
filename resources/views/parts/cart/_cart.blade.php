                                            ...
                                            <div class="items">
                                                ...
                                                <div class="col-md-3">
                                                    <div style="text-align: center;">
                                                        <h3>Total</h3>
                                                        @if($subTotal == 0)
                                                            <h3><span style="color:green;">${{ $totalCart }}</span></h3>
                                                        @else
                                                            <h3>
                                                                <del><span style="color:green;">${{ $totalCart }}</span>
                                                                </del>
                                                            </h3>
                                                            <p>${{ $subTotal }}</p>
                                                        @endif
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <b>Ayúdenos a mantener su cuenta segura, verifique su información de
                                            facturación.</b>
                                        <p>Tengo cuenta <a href="" class="btn btn-primary">Ingresar</a> | Me quiero
                                            registrar <a href="" class="btn btn-primary">Registrarme</a></p>
                                        <br/><br/>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control" id="id_state" name="state">
                                                        <option value="CIUDAD AUTÓNOMA DE BUENOS AIRES" selected>
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div style="text-align: left;"><br/>
                                            ...
                                            Si usted tiene alguna duda sobre los productos o los servicios por favor no
